(() => {
    ...
    function rangeInit() {
        ...
        if (priceSlider) {
            ...
            priceSlider.noUiSlider.on("update", (function(values, handle) {
                if (handle) document.querySelector(".filter__val-max").innerHTML = values[handle]; else document.querySelector(".filter__val-low").innerHTML = values[handle];
            }));
        }
    }
    rangeInit();
    ...
    window.addEventListener("DOMContentLoaded", (() => {
        ...
        function documentActions(e) {
            ...
            if (targetElement.closest(".tags__item")) targetElement.closest(".tags__item").classList.toggle("_active");
            if (targetElement.closest(".sort__button")) document.querySelector("html").classList.add("_filter-active", "lock");
            if (targetElement.closest(".filters__close")) document.querySelector("html").classList.remove("_filter-active", "lock");
